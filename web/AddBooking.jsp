        ...
        <form action="BookingController">
            ...
            <form action="BookingController">
                <div class="center">         
                    ...
                    <p style="font-size: 20px">Customer Name : <input readonly type="text" name="name" value="<%=session.getAttribute("logined")%>" required/></p>  <br><br>  
                        <%} else {%>
                    ...
                    <p style="font-size: 20px">Route: 
                        ...
                        %>
                    <p style="font-size: 20px">Date:  <input readonly type="text" name="date" value="<%=currentDay%>" required/></p> <br><br>
